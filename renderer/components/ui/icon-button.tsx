...
export const IconButton = React.forwardRef<HTMLButtonElement, IconButtonProps>(
  ({ className, children, tone = 'default', type = 'button', ...props }, ref) => (
    <button
      ...
      type={type}
      className={cn(
        'inline-flex shrink-0 items-center justify-center rounded-full p-1.5 transition-colors outline-none active:scale-95 motion-reduce:transform-none focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 disabled:active:scale-100 [&_svg]:pointer-events-none',
        toneClasses[tone],
        className
      )}
      {...props}
